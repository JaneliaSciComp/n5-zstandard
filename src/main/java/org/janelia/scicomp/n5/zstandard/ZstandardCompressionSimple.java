...
public class ZstandardCompressionSimple implements DefaultBlockReader, DefaultBlockWriter, Compression {
	 ...
	 */
	public ZstandardCompressionSimple() {
	 ...
	 */
	public ZstandardCompressionSimple(int level) {
		this.level = level;
	}
