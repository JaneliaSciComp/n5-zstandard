...
public class ZstandardCompressionAdvanced implements DefaultBlockReader, DefaultBlockWriter, Compression {
	...
	/**
	 * Create ZstandardCompression with level equal to the constant ZSTD_CLEVEL_DEFAULT (value: {@value ZstandardCompressionAdvanced#ZSTD_CLEVEL_DEFAULT})
	 *
	 ...
	 */
	public ZstandardCompressionAdvanced() {
	 ...
	 *              The default value is  {@value ZstandardCompressionAdvanced#ZSTD_CLEVEL_DEFAULT}.
	 */
	public ZstandardCompressionAdvanced(int level) {
		this.level = level;
	}
